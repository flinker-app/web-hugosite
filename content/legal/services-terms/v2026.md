---
title: "Flinker Services Terms (v2026)"
date: 2026-01-14
draft: false
description: "Legacy link for Flinker Services Terms (v2026). Redirects to the canonical v2026-01 page."
author: "Flinker GmbH"
canonical_url: "https://flinker.app/legal/services-terms/v2026-01/"
url: "/legal/services-terms/v2026/"
layout: "mdpage"

redirect_to: "/legal/services-terms/v2026-01/"
---

<meta http-equiv="refresh" content="0; url={{< param key="redirect_to" >}}" />

<div class="alert alert-warning" role="alert">
  This legacy link points to a canonical versioned page.
  If you are not redirected automatically, please open
  <a href="{{< param key="redirect_to" >}}">{{< param key="redirect_to" >}}</a>.
</div>

<div class="d-flex flex-wrap gap-2 mb-4">
  <a class="btn btn-outline-secondary" href="/legal/services-terms/">Back to latest</a>
  <a class="btn btn-outline-secondary" href="{{< param "pdf_path" >}}" target="_blank" rel="noopener">Download PDF</a>
...
These Flinker Services Terms (v2026) (“Terms”) apply to the services described in the quote (“Services”) provided by Flinker GmbH (“Flinker”) to the customer (“Customer”). If the parties have a signed master agreement or SOW that conflicts with these Terms, the signed agreement prevails.
